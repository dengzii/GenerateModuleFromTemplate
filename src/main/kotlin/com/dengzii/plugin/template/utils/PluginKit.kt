...
class PluginKit private constructor(e: AnActionEvent) {
    ...
    fun createFileFromTemplate(
        ...
        val template =
            fileTemplateManager.getTemplate(templateName) ?: throw IllegalArgumentException("template not found.")
        val psiDirectory =
            getPsiDirectoryByVirtualFile(directory) ?: throw IllegalArgumentException("directory not found.")
        return try {
    ...
    companion object {
        ...
        fun getAllFileTemplate(): Array<FileTemplate> {
            val ts = FileTemplateManagerImpl.getDefaultInstance().allTemplates
            return ts
        }
